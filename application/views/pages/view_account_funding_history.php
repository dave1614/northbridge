        ...
        var global_user_id = "";
         function addCommas(nStr)
          ...
          function performActionOnDepositRequest(elem,evt,id){
            ...
            var url = "<?php echo site_url('sabicapital/index/admin/view_more_info_on_superforex_deposit_request_history') ?>";
            var form_data = {
              'show_records' : true,
              'id' : id
            }
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($rows)){
                      ...
                      foreach($rows as $row){
                        ...
                        $response_arr['messages'] .= '<tr onclick="performActionOnDepositRequest(this,event,'.$id.')">';
