      ...
      <script>
        var global_user_id = "";
         function addCommas(nStr)
          ...
          function approveThisRequest(elem,evt,id){
            swal({
              title: 'Warning',
              text: "Are You Sure You Want To Approve This Request?",
              type: 'warning',
              ...
              var url = "<?php echo site_url('sabicapital/index/admin/approve_sabi_account_manager_request') ?>";
              var form_data = {
                id: id
              }
          ...
          function declineThisRequest(elem,evt,id){
            swal({
              title: 'Warning',
              ...
              var url = "<?php echo site_url('sabicapital/index/admin/decline_sabi_acccount_manager_request') ?>";
              var form_data = {
                id: id
              }
          ...
          function viewApprovedRequests (elem,evt) {
            var url = "<?php echo site_url('sabicapital/index/admin/view_approved_sabi_account_manager_requests') ?>";
              ...
              <div class="card" id="main-card">
                ...
                <?php
                  ...
                  if(isset($rows)){
                    ...
                    $response_arr['messages'] .= "<div class='form-group'>";
                    $response_arr['messages'] .= "<input type='email' class='form-control' name='email' id='email' placeholder='Email'";
                    ...
                    $response_arr['messages'] .= "<div class='form-group'>";
                    $response_arr['messages'] .= "<input type='number' class='form-control' name='start_capital' id='start_capital' placeholder='Start Capital' step='any'";

                    if(isset($_GET['start_capital'])){
                      $response_arr['messages'] .= "value='" .  $_GET['start_capital'] . "'";
                    }
                    ...
                    $response_arr['messages'] .= "<div class='form-group'>";
                    $response_arr['messages'] .= "<input type='date' class='form-control' name='approved_date_time' id='approved_date_time' placeholder='Approval Date'";

                    if(isset($_GET['approved_date_time'])){
                      $response_arr['messages'] .= "value='" . $_GET['approved_date_time'] . "'";
                    }
                    ...
                    if(is_array($rows)){
                      ...
                      $response_arr['messages'] .= '<th>Start Capital</th>';
                      $response_arr['messages'] .= '<th>Request Date / Time</th>';
                      $response_arr['messages'] .= '<th>Approval Date / Time</th>';
                      ...
                      foreach($rows as $row){
                        ...
                        $response_arr['messages'] .= '<td><em class="text-primary">'.$email.'</em></td>';
                        $response_arr['messages'] .= '<td><em class="text-primary">'.number_format($start_capital,2).'</em></td>';
                        $response_arr['messages'] .= '<td class="date">'.$date_time.'</td>';
                        $response_arr['messages'] .= '<td class="date">'.$approved_date_time.'</td>';
      ...
      <script>
        $(document).ready(function () {
          ...
          $("#main-card #filter-rows-form").submit(function (evt) {
            ...
            var start_capital = me.find("#start_capital").val()
            var super_forex_account_number = me.find("#super_forex_account_number").val()
            var approved_date_time = me.find("#approved_date_time").val()
            ...
            var url = "<?php echo site_url('sabicapital/index/'.$addition.'/'.$second_addition); ?>?full_name="+full_name+"&phone="+phone+"&email="+email+"&start_capital="+start_capital+"&super_forex_account_number="+super_forex_account_number+"&date="+date+"&approved_date_time="+approved_date_time;
