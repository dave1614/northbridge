                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($rows)){
                      ...
                      foreach($rows as $row){
                        ...
                        $response_arr['messages'] .= '<button onclick="approveThisRequest(this,event,'.$id.')" type="button" rel="tooltip" title="Approve This Request" class="btn btn-success" style="margin-right: 10px;">';
                        ...
                        $response_arr['messages'] .= '<button onclick="declineThisRequest(this,event,'.$id.')" type="button" rel="tooltip" title="Decline This Request" class="btn btn-danger">';
                        $response_arr['messages'] .= '<i style="color: #fff;" class="fas fa-times"></i>';
                        $response_arr['messages'] .= '<div class="ripple-container"></div>';
                        $response_arr['messages'] .= '</button>';
      ...
      <script>
        $(document).ready(function () {
          ...
          $("#main-card #filter-rows-form").submit(function (evt) {
            ...
            var url = "<?php echo site_url('sabicapital/index/'.$addition.'/'.$second_addition); ?>?full_name="+full_name+"&phone="+phone+"&email="+email+"&start_capital="+start_capital+"&super_forex_account_number="+super_forex_account_number+"&date="+date;
