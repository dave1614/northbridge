...
<!-- Page Content -->
  <div class="">
    <div class="container-fluid">
      ...
      <h3 class="text-center heading-text">Sabi Academy</h3>
      ...
      <div class="row justify-content-center">
        ...
        <div class="card shadow col-sm-6" style="min-height: 300px; margin-top: 30px;" id="main-card">
          <div class="card-body">
            <?php
            $attr = array('id' => 'sabi-academy-form');
            echo form_open_multipart('sabicapital/submit_request_for_sabi_academy',$attr);
            ?>
            <p style="color: #7ea960;">Fill Form To Request Sabi Academy</p>
  ...
  <script>
    $(document).ready(function () {
      ...
      $("#sabi-academy-form").submit(function (evt) {
        evt.preventDefault();
        var me = $(this);
